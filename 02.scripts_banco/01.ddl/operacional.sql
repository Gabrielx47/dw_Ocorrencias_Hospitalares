...
VALUES(1,'MONICA', '123123123', 'AGROVILA', 'CENTRO', 'MOITA BONITA', 'SE', 'F', '1995-02-10')
...
CREATE INDEX IX_HOSPITAL_OCORRENCIA ON TB_OCORRENCIA (COD_HOSPITAL)
CREATE INDEX IX_FAIXA_ETARIA ON TB_OCORRENCIA (COD_FAIXA_ETARIA)
CREATE INDEX IX_DATA_OCORRENCIA ON TB_OCORRENCIA(DATA_OCORRENCIA)
