...
CREATE INDEX IX_DIM_HOSTIPAL_COD_HOSPITAL ON DIM_HOSPITAL(COD_HOSPITAL)
...
CREATE TABLE FATO_OCORRENCIA (
	ID_OCORRENCIA INT identity(1, 1),
...
CREATE INDEX IX_FATO_OCORRENCIA_MEDICO ON FATO_OCORRENCIA(ID_MEDICO)